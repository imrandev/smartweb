            ...
            <form name="myForm" class="form-horizontal">
                ...
                <div class="row">
                    <div class="form-actions floatRight">
                        <input type="submit"  value="{{!user.id ? 'Add' : 'Update'}}" class="btn btn-primary btn-sm" ng-disabled="myForm.$invalid" ng-click="addUser();">
                        <button type="button" ng-click="" class="btn btn-warning btn-sm" ng-disabled="myForm.$pristine">Reset Form</button>
                    </div>
                </div>
            </form>
        </div>
